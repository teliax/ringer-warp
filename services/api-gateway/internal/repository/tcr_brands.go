...
func (r *TCRBrandRepository) Update(ctx context.Context, id uuid.UUID, req *models.UpdateBrandRequest, updatedBy uuid.UUID) error {
	query := `
		...
		SET display_name = COALESCE($1, display_name),
		    ...
		    primary_contact_email = COALESCE($14, primary_contact_email),
		    primary_contact_phone = COALESCE($15, primary_contact_phone),
		    business_contact_first_name = COALESCE($16, business_contact_first_name),
		    business_contact_last_name = COALESCE($17, business_contact_last_name),
		    business_contact_email = COALESCE($18, business_contact_email),
		    business_contact_phone = COALESCE($19, business_contact_phone),
		    stock_symbol = COALESCE($20, stock_symbol),
		    stock_exchange = COALESCE($21, stock_exchange),
		    alt_business_id = COALESCE($22, alt_business_id),
		    alt_business_id_type = COALESCE($23, alt_business_id_type),
	...
	_, err := r.db.Exec(ctx, query,
		...
		req.Website, req.Vertical, req.Email, req.Phone,
